return {
  {
    ...
    config = function()
      ...
      vim.keymap.set("x", "sr", call_visual_command, opts)

      vim.api.nvim_set_keymap("n", "sr", "<CMD>SearchReplaceSingleBufferCWord<CR>", opts)
      vim.api.nvim_set_keymap("n", "sR", "<CMD>SearchReplaceSingleBufferCExpr<CR>", opts)
    end,
  },
}
